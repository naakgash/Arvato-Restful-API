...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Arvato.Core.Collection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Arvato.Core.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Arvato.Core.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Arvato.Core.Language", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Arvato.Core.Movie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CollectionMovie", b =>
                {
                    b.HasOne("Arvato.Core.Collection", null)
                        .WithMany()
                        .HasForeignKey("CollectionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Arvato.Core.Movie", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CountryMovie", b =>
                {
                    b.HasOne("Arvato.Core.Country", null)
                        .WithMany()
            ...
            modelBuilder.Entity("GenreMovie", b =>
                {
                    b.HasOne("Arvato.Core.Genre", null)
                        .WithMany()
            ...
            modelBuilder.Entity("LanguageMovie", b =>
                {
                    ...
                    b.HasOne("Arvato.Core.Language", null)
                        .WithMany()
